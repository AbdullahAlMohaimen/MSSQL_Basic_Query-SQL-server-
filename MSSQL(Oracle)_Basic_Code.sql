...
select EMPLOYEE_SALARY as Salary ,count(EMPLOYEE_SALARY) as Total from EMPLOYEE group by EMPLOYEE_SALARY;
select EMPLOYEE_SALARY as Salary ,count(EMPLOYEE_SALARY) as Total from EMPLOYEE group by EMPLOYEE_SALARY;
...
--SIMPLE JOIN
select EMPLOYEE_NAME,EMPLOYEE_AGE,ORDER_DATE from EMPLOYEE e join ITEMORDER i on e.EMPLOYEE_ID=i.EMPLOYEE_ID;
select EMPLOYEE_NAME,EMPLOYEE_AGE,ORDER_DATE from EMPLOYEE e join ITEMORDER i on e.EMPLOYEE_ID=i.EMPLOYEE_ID order by ORDER_DATE;
...
--INNER JOIN
select EMPLOYEE_NAME,floor(Rent_TotalPrice) from EMPLOYEE a inner join Rent b on a.EMPLOYEE_ID=b.EMPLOYEE_ID;
select EMPLOYEE_NAME,DEPARTMENT_NAME from EMPLOYEE a inner join DEPARTMENT b on a.DEPARTMENT_ID=b.DEPARTMENT_ID order by DEPARTMENT_NAME;
...
inner join RENT b on a.EMPLOYEE_ID=b.EMPLOYEE_ID Inner join VEHICLE c on b.VEHICLE_ID=c.VEHICLE_ID order by RENT_DATE;
select DEPARTMENT_NAME,EMPLOYEE_NAME,EMPLOYEE_SALARY from EMPLOYEE,DEPARTMENT where EMPLOYEE.DEPARTMENT_ID=Department.DEPARTMENT_ID;
select EMPLOYEE_NAME from EMPLOYEE,ITEMORDER where EMPLOYEE.EMPLOYEE_ID=ITEMORDER.EMPLOYEE_ID;
select EMPLOYEE_NAME,DEPARTMENT_NAME,EMPLOYEE_SALARY from EMPLOYEE e INNER JOIN DEPARTMENT d on e.DEPARTMENT_ID=d.DEPARTMENT_ID;
...
--LEFT JOIN
select a.EMPLOYEE_ID,EMPLOYEE_NAME,EMPLOYEE_AGE,RENT_DATE from EMPLOYEE a left join RENT b on a.EMPLOYEE_ID=b.EMPLOYEE_ID;
select EMPLOYEE_NAME,RENT_DATE,RENT_TOTALDAYS,RENT_TOTALPRICE from EMPLOYEE e Left join RENT r on e.EMPLOYEE_ID=r.EMPLOYEE_ID;
select a.EMPLOYEE_ID,EMPLOYEE_NAME,EMPLOYEE_EMAIL,VEHICLE_NAME,VEHICLE_SEAT,RENT_DATE from EMPLOYEE a 
left join RENT b on a.EMPLOYEE_ID=b.EMPLOYEE_ID left join VEHICLE c on b.VEHICLE_ID=c.VEHICLE_ID order by a.EMPLOYEE_ID;
...
select EMPLOYEE_NAME,RENT_DATE,EMPLOYEE_GENDER,VEHICLE_NAME from EMPLOYEE E 
LEFT JOIN RENT R ON E.EMPLOYEE_ID=R.EMPLOYEE_ID
LEFT JOIN VEHICLE V ON R.VEHICLE_ID=V.VEHICLE_ID AND  V.VEHICLE_NAME LIKE '%Ena%' where V.VEHICLE_NAME !=NULL;

select EMPLOYEE_NAME,RENT_DATE,EMPLOYEE_GENDER,VEHICLE_NAME from EMPLOYEE E 
LEFT JOIN RENT R ON E.EMPLOYEE_ID=R.EMPLOYEE_ID
LEFT JOIN VEHICLE V ON R.VEHICLE_ID=V.VEHICLE_ID AND  V.VEHICLE_NAME LIKE '%Ena%' where E.EMPLOYEE_GENDER !='Male';
...
--RIGHT JOIN
select EMPLOYEE_NAME,RENT_DATE,RENT_TOTALDAYS,RENT_TOTALPRICE from EMPLOYEE e right join RENT r on e.EMPLOYEE_ID=r.EMPLOYEE_ID;
select EMPLOYEE_NAME,DEPARTMENT_NAME from EMPLOYEE e right join DEPARTMENT d on e.DEPARTMENT_ID=d.DEPARTMENT_ID;
select VEHICLE_NAME,floor(VEHICLE_RENTPRICE),RENT_DATE from VEHICLE a right join RENT b on a.VEHICLE_ID=b.VEHICLE_ID;
select VEHICLE_NAME,floor(VEHICLE_RENTPRICE),RENT_DATE from VEHICLE a right join RENT b on a.VEHICLE_ID=b.VEHICLE_ID
...
AND e.EMPLOYEE_ADDRESS = b.EMPLOYEE_ADDRESS
ORDER BY e.EMPLOYEE_ADDRESS;

SELECT e.EMPLOYEE_NAME as Employee_Name, e.EMPLOYEE_ADDRESS as Address FROM EMPLOYEE e join EMPLOYEE b
...
select EMPLOYEE_NAME,EMPLOYEE_ADDRESS,RENT_DATE from EMPLOYEE a full outer join RENT b on a.EMPLOYEE_ID=b.EMPLOYEE_ID;
select EMPLOYEE_NAME,EMPLOYEE_ADDRESS,RENT_DATE from EMPLOYEE a full outer join RENT b on a.EMPLOYEE_ID=b.EMPLOYEE_ID
